...
export const metadata: Metadata = {
  title: "TechFund | European Venture Capital for Innovation",
  description: "Invest in Europe's next generation of tech companies. €450M+ deployed across AI, fintech, enterprise software, and deep tech.",
  keywords: "venture capital Italy, European VC, tech investment, startup funding, AI investment",
  metadataBase: new URL("https://techfund.com"),
  alternates: {
    canonical: "https://techfund.com"
  },
  openGraph: {
    title: "TechFund | European Venture Capital",
    description: "Empowering innovation in Italy and beyond. Strategic capital + operational expertise for breakthrough tech companies.",
    siteName: "TechFund",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764123882699-7vtjuvkj.jpg",
      alt: "TechFund Investment"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "TechFund | European Venture Capital",
    description: "Invest in tech companies reshaping industries across Europe.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764123882699-7vtjuvkj.jpg"]
  },
  robots: {
    index: true,
    follow: true
